...
const defaultOutput = join(process.env.LOCALAPPDATA ?? process.cwd(), 'NateOVisionBuild', 'release');
...
const builderArgs = ['--config', 'electron-builder.yml', `--config.directories.output=${outputDir}`];
